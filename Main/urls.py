...
from .views import home, customers,products,orders,create_customers,create_products,create_orders,update_customer,delete_customer,update_product,delete_product,update_order,delete_order,claims,create_claims,update_claim,delete_claim
